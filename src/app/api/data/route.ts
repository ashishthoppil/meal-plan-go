...
const FeaturesData: FeaturesType[] = [
  {
    ...
    subheading:
      'Get a 7-day plan tailored to your taste, diet, and schedule — no more dinner-time stress.',
  },
  {
    imgSrc: '/images/Features/featureThree.svg',
    heading: 'Automatic Grocery Lists',
    subheading:
      'Instantly generate a sorted, ready-to-shop list for your entire week.',
  },
  {
    imgSrc: '/images/Features/featureTwo.svg',
    heading: 'Healthy & Tasty Recipes',
    subheading:
      'Enjoy balanced, easy-to-cook meals that don’t sacrifice flavor.',
  },
  {
    imgSrc: '/images/Features/featureFour.svg',
    heading: 'Save Time & Money',
    subheading:
      'Spend less time planning and shopping — and cut down on food waste.',
  }
]
